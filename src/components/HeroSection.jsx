...
export default function HeroSection({ darkMode, toggleDarkMode }) {
  return (
    <section className="hero-card card animate-in">
      <div className="hero-content">
        <div className="hero-photo">
          <img src="/me.jpg" alt="Marvin Pescos" />
        </div>
        <div className="hero-info">
          ...
          <div className="hero-actions">
            ...
            <a href="https://github.com/MarvinPescos" target="_blank" rel="noopener noreferrer" className="btn-outline">
